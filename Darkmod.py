...
name = raw_input ("\033[91mMasukan Nama kamu! : ")
...
password = getpass.getpass("\x1b[1;92mMasukan Password Nya! : ")


if password == ("T4ufik909"):
     os.system('clear')
     ...
     time.sleep(0.5)
     print 'bang ' + name + ' tolong Gunain tools dengan baik'
     time.sleep(0.5)
     print ' Black Hat Cyber'
     time.sleep(0.5)
     print 'bang ' + name + ' add Wa aku ya kalo tools rusak <082215060250>'
     time.sleep(0.5)
     print 'nick: BHC•T4ufik✓'
     time.sleep(3.0)
else:
     print ("Pm Author nya Kalau Mau Pw nya")
     print ("WA 082215060250")
     os.sys.exit()
...
\033[1;97m ██ ██
\033[1;97m╔════════════════════════════════════════════╗
\033[1;97m║\033[1;93m* \033[1;97mAuthor  \033[1;91m: \033[1;96mT4ufik909 \033[1;97m                      ║
\033[1;97m║\033[1;93m* \033[1;97mGitHub  \033[1;91m: \033[1;92m\033[4mgithub.com/MrTaufik909    \033[0m \033[1;97m     ║
\033[1;97m╚════════════════════════════════════════════╝"""
...
def pilih():
	...
	if zedd =="":
		...
		os.system('rm -rf login.txt')
		os.system('xdg-open https://m.facebook.com/taufik.id.9822')
		keluar()
	elif zedd =="0":
		keluar()
	else:
